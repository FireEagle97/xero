...
const Header = () => {
  ...
  return (
    <header className={clsx("fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4", hasScrolled && "py-2 bg-black-100 backdrop-lur-[8px]")}>
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        >
          <div
            ...
            max-lg:min-h-screen max-lg:p-5 max-lg:overflow-hidden sidebar:before max-md:px-4"
          >
            ...
            h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
              ...
              />
              {/* inset means top ,bottom,left.right is 0 */}
              <img
